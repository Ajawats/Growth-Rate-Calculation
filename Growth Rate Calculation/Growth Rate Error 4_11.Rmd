...
###### Note to keep: setwd("/Users/allisonadams/OneDrive/Documents/Thesis Work/Growth Rates/Allison")
getwd()
...
#### Read in the Hunger Games Growth Rate file
```{r}
...
#### Make a new name for the Hunger Games growth rate data

```{r}
grow <- HGGR_Test
```

#Create data frame with date, station, approx.days, rep, label, & volume and name it "x"
```{r}
...
#### take natural log of volume measurement
```{r}
...
x$ugC <- exp(x$LnC) 
str(x)
VolumeCalibration$brokenModel
```
#### load Bquick function 
```{r}
